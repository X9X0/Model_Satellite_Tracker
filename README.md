# SatelliteTracker
This repository contains the code for alexchang0229's satellite tracker. It has been updated to work in accordance with celestrak.org's updated GET format. Debug output via serial ws also updated ot be a bit more verbose. TLE parsing and validation improvements.:<br />
